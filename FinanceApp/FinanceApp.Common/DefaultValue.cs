...
namespace FinanceApp.Common
{
    public class DefaultValue
    {
        ...
        private const string domain = "maikegroup.com";
        private const string _cookie = "Test";
        private const string siteName = "http://site.maikegroup.com/";
        private const string passPortUrl = "http://passport.maikegroup.com/";
        private const string systemName = "迈科资产(" + sign + ")";
        private const string _V1ConnectString = "Data Source=192.168.13.205;Initial Catalog=BussinessNow;User ID=sa;Password=7788250";
        private const string sign = "本地";

        private static readonly DateTime defaultTime = DateTime.Parse("1900-01-01");
        private static readonly System.Data.DataTable defaultTable = new System.Data.DataTable();
